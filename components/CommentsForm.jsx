...
const CommentsForm = ({ slug }) => {
  ...
  // we're not using states for these values as we just wanna read the vals from input fields and send to GraphCMS. more efficient than useState.
  ...
  //can use Toastify for error messages!
